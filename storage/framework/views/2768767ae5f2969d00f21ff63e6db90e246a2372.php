...
<?php $__env->startSection('cms'); ?>
    <?php if(isset($page)): ?>
        <?php echo Cms::editBtn('pages', $page->id); ?>
    <?php endif; ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('cms-frontend::layout.master', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>